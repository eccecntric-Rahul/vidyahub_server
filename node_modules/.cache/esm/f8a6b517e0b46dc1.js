let studentModel,moment,EnrollmentModel,FeeModel;_e0b‍.x([["default",()=>_e0b‍.o],["dsearch",()=>dsearch],["loadEnrollment",()=>loadEnrollment],["getEnrollmentDetails",()=>getEnrollmentDetails],["getFeeDetails",()=>getFeeDetails],["getStudent",()=>getStudent]]);_e0b‍.w("../model/studentModel",[["default",["studentModel"],function(v){studentModel=v}]]);_e0b‍.w("moment",[["default",["moment"],function(v){moment=v}]]);_e0b‍.w("../model/EnrollmentModel",[["default",["EnrollmentModel"],function(v){EnrollmentModel=v}]]);_e0b‍.w("../model/feeModel",[["default",["FeeModel"],function(v){FeeModel=v}]]);
...
const getStudent= async(req,res)=>{
    ...
    const searchResult=await studentModel.find({
                ...
                _e0b‍.g.console.log(data);
        if(searchResult){
            res.send(searchResult);
        }
}

       const loadEnrollment= async (req,res)=>{
...
if(resp){
    ...
    res.send("no user found");
       ...
       const getEnrollmentDetails= async (req,res)=>{
        _e0b‍.g.console.log(req.headers.url);
    ...
    _e0b‍.g.console.log(req.headers);
